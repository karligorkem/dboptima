...
MODEL_PATH = (
    ARTIFACT_DIR
    / "index_improvement_model_grouped.joblib"
)

METADATA_PATH = (
    ARTIFACT_DIR
    / "index_improvement_model_grouped_metadata.json"
)
...
def train() -> None:
    ...
    if unique_query_count < 5:
        raise RuntimeError(
            "Too few unique query families "
